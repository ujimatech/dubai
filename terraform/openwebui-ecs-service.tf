# module "mcpoproxy-container" {
#   source = "terraform-aws-modules/ecs/aws//modules/container-definition"
#
#   name      = "mcpo-proxy"
#   image     = aws_ecr_repository.mcpo_proxy.repository_url
#   cpu       = 1024
#   memory    = 2048
#   essential = true
...
#     logDriver = "awslogs"
#     options = {
#       "awslogs-group"         = "/ecs/mcpo-proxy"
#       "awslogs-region"        = "us-west-2"
#       "awslogs-create-group"  = "true"
#       "awslogs-stream-prefix" = "mcpo-proxy"
#     }
#   }
#
# }
...
#     {
#       name      = "GITHUB_TOKEN"
#       valueFrom = "${aws_secretsmanager_secret.dubai_secrets.arn}:GITHUB_TOKEN::"
#     }
#   ]
#
#   log_configuration = {
...
#     module.mcpoproxy-container.container_definition
#   ])
# }
#
